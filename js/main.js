...
$('#wp-developer').circleProgress({
	...
	$(this).find('.progressbar-percetage').html(Math.round(87 * progress) + '<i>%</i>');
});
$('#web-dev').circleProgress({
	...
	$(this).find('.progressbar-percetage').html(Math.round(95 * progress) + '<i>%</i>');
});
$('#e-com-dev').circleProgress({
	value: 0.93,
	size: 80,
	thickness: 10,
	emptyFill: '#f6f6f0',
	...
	$(this).find('.progressbar-percetage').html(Math.round(92 * progress) + '<i>%</i>');
});
...
$('#android-dev').circleProgress({
	...
	$(this).find('.progressbar-percetage').html(Math.round(91 * progress) + '<i>%</i>');
});
